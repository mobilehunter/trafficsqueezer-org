...
<tr>
<td align=middle ><form method="POST" action="w_wan_port_simulation_bknd.php?port=none">
<input title="Remove WAN Port ?" type="submit" name="submit_ok" value="None" style="border:0;background-color:#B6B6B6;color:white;font-weight:bold;font-size:11px;" />
</form></td>
</tr>
<tr>
<?php include("c_db_access.php");
	...
	if(mysql_num_rows($result) > 0)
	{
	  while($row = mysql_fetch_array($result))
	  {
		 ...
		 print "</td>";
		 print "<td align=middle ><form method=\"POST\" action=\"w_wan_port_simulation_bknd.php?port=$name\">";
...
<tr>
<td align=middle ><form method="POST" action="w_finish.php">
